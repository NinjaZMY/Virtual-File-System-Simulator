...
export function AddUser(id, lib) {
...
export let root_id = AddFolder(fid, uid, "", null);// this is root 

export let p1 = AddFolder(fid, uid, "folder des noobs ", root_id);// p1  
export let p2 = AddFolder(fid, uid, "Dossier de Surveys", root_id);// p2 
export let p3 = AddFolder(fid, uid, "Google Ads"
    , root_id); // p3 
...
export let k = 1;
export let dom_string = "";
export let query_index = 0;
...
export let Background_img_on = 0; //for background image off use 0 or false ; 
