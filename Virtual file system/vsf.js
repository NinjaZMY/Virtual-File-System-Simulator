...
//***********
function Folder_has_Children(pid)
{
...
function ALL_Folders_Having_Level(L,pid,is_root=L==0) {
    let N = Folders.length;
...
for (let i = 0; i <= LvL_Height; i++) {
    ...
    tabValue = Level_Counter * Tabulation;
